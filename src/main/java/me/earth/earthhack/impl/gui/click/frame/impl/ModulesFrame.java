...
public class ModulesFrame extends Frame {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (CLICK_GUI.get().size.getValue()) {
            ...
            Managers.TEXT.drawStringWithShadow(disString, (getPosX() + getWidth() - 3 - Managers.TEXT.getStringWidth(disString)), (getPosY() + getHeight() / 2 - (Managers.TEXT.getStringHeight() >> 1)), 0xFFFFFFFF);
        }
        if (isExtended()) {
