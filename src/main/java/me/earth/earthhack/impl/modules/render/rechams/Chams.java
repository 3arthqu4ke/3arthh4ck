...
public class Chams extends Module
{
    ...
    public final Setting<NameableImage> wallsImage =
            register(new ListSetting<>("WallsImage", Managers.FILES.getInitialImage(), Managers.FILES.getImages()));
    ...
    public final Setting<GifImage> wallsGif =
            register(new ListSetting<>("WallsGif", Managers.FILES.getInitialGif(), Managers.FILES.getGifs()));
    ...
    public final Setting<SettingShader> shader =
            register(new ListSetting<>("Shader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> wallsShader =
            register(new ListSetting<>("WallsShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> framebufferShader =
            register(new ListSetting<>("FramebufferShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> wallsFramebufferShader =
            register(new ListSetting<>("WallsFramebufferShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    ...
    public final Setting<NameableImage> friendImage =
            register(new ListSetting<>("F-Image", Managers.FILES.getInitialImage(), Managers.FILES.getImages()));
    public final Setting<NameableImage> friendWallsImage =
            register(new ListSetting<>("F-WallsImage", Managers.FILES.getInitialImage(), Managers.FILES.getImages()));
    ...
    public final Setting<GifImage> friendGif =
            register(new ListSetting<>("F-Gif", Managers.FILES.getInitialGif(), Managers.FILES.getGifs()));
    public final Setting<GifImage> friendWallsGif =
            register(new ListSetting<>("F-WallsGif", Managers.FILES.getInitialGif(), Managers.FILES.getGifs()));
    ...
    public final Setting<SettingShader> friendShader =
            register(new ListSetting<>("F-Shader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> friendWallsShader =
            register(new ListSetting<>("F-WallsShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> friendFramebufferShader =
            register(new ListSetting<>("F-FramebufferShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> friendWallsFramebufferShader =
            register(new ListSetting<>("F-WallsFramebufferShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    ...
    public final Setting<NameableImage> enemyImage =
            register(new ListSetting<>("E-Image", Managers.FILES.getInitialImage(), Managers.FILES.getImages()));
    public final Setting<NameableImage> enemyWallsImage =
            register(new ListSetting<>("E-WallsImage", Managers.FILES.getInitialImage(), Managers.FILES.getImages()));
    ...
    public final Setting<GifImage> enemyGif =
            register(new ListSetting<>("E-Gif", Managers.FILES.getInitialGif(), Managers.FILES.getGifs()));
    public final Setting<GifImage> enemyWallsGif =
            register(new ListSetting<>("E-WallsGif", Managers.FILES.getInitialGif(), Managers.FILES.getGifs()));
    ...
    public final Setting<SettingShader> enemyShader =
            register(new ListSetting<>("E-Shader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> enemyWallsShader =
            register(new ListSetting<>("E-WallsShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> enemyFramebufferShader =
            register(new ListSetting<>("E-FramebufferShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> enemyWallsFramebufferShader =
            register(new ListSetting<>("E-WallsFramebufferShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    ...
    public final Setting<NameableImage> crystalImage =
            register(new ListSetting<>("C-Image", Managers.FILES.getInitialImage(), Managers.FILES.getImages()));
    public final Setting<NameableImage> crystalWallsImage =
            register(new ListSetting<>("C-WallsImage", Managers.FILES.getInitialImage(), Managers.FILES.getImages()));
    ...
    public final Setting<GifImage> crystalGif =
            register(new ListSetting<>("C-Gif", Managers.FILES.getInitialGif(), Managers.FILES.getGifs()));
    public final Setting<GifImage> crystalWallsGif =
            register(new ListSetting<>("C-WallsGif", Managers.FILES.getInitialGif(), Managers.FILES.getGifs()));
    ...
    public final Setting<SettingShader> crystalShader =
            register(new ListSetting<>("C-Shader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> crystalWallsShader =
            register(new ListSetting<>("C-WallsShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> crystalFramebufferShader =
            register(new ListSetting<>("C-FramebufferShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
    public final Setting<SettingShader> crystalWallsFramebufferShader =
            register(new ListSetting<>("C-WallsFramebufferShader", Managers.FILES.getInitialShader(), Managers.FILES.getShaders()));
