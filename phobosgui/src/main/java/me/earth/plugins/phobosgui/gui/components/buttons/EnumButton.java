...
public class EnumButton<E extends Enum<E>> extends Button
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        PhobosTextManager.getInstance().drawStringWithShadow(setting.getName() + " " + TextColor.GRAY + setting.getValue().name(), x + 2.3F, y - 1.7F - PhobosGui.getInstance().getTextOffset(), getState() ? 0xFFFFFFFF : 0xFFAAAAAA);
    }
